        ...
        >
            ...
            <ul className="pt-6">
                {Menus.map((Menu, index) => (
                    <li
                        key={index}
                        className={`flex p-2  text-gray-300 text-lg items-center gap-x-4 ${Menu.readOnly ? " mt-9 border-b " : " rounded-md cursor-pointer hover:bg-light-white "} ${Menu.gap ? "mt-9" : "mt-2"} ${index === 0 && "bg-light-white"} `}
                        onClick={() => { handleClick() }}
                    >
