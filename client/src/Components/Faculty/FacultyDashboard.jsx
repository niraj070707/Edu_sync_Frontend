        ...
        <main className="p-6 sm:p-10 space-y-6">
          ...
          <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">xyz</span>
                <span className="block text-gray-500"> No. of Divsions under u</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              ...
              <div>
                <span className="block text-2xl font-bold">xyz</span>
                <span className="block text-gray-500">No. of batches under u</span>
              </div>
            </div>
            <div className="flex items-center p-8 bg-white shadow rounded-lg">
              <div className="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-purple-600 bg-blue-100 rounded-full mr-6">
              ...
              <div>
                <span className="block text-2xl font-bold">xyz</span>
                <span className="block text-gray-500">Mentorship Grps under u</span>
              </div>
            </div>
          </section>
          <section>
